        ...
        <table class="table table-hover">
            ...
            <?php
                ...
                foreach ($proteinas as $p){
                    $acoes = (Yii::$app->user->isGuest ? '':'<td>'.Html::a("Editar", ['proteina/editar', 'proteina'=>$p['id']])." / ".Html::a("Remover", ['proteina/remover', 'proteina'=>$p['id']]).'</td>');
                    echo '<tr>
                            <td>' . Html::a($p['nome'], ['proteina/visualizar', 'proteina'=>$p['id']]). '</td>'.$acoes.'
                          </tr>';
                }
            ?>
            </tbody>
